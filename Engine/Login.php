...
class Login
{
     ...
     * @return void|boolean TRUE if okay, FALSE otherwise
     **/
            ...
            if ($stmt->execute()){
                if($stmt->rowCount() > 0) {
                    ...
                    if(password_verify($password, $hashed_password)){
                        ...
                        $user_key_encoded =  Encryption::authenticateUser($password, $secret);

                        /** Log in the user */
                        Session::set("uid", $row['user_id']);
                        Session::set("isLoggedIn", true);
                        Session::set("secret", $user_key_encoded);
